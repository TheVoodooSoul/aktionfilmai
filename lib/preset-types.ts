...
// FAL LoRA URLs - Your trained models
export const FAL_LORA_URLS = {
  punch: 'https://v3.fal.media/files/zebra/-x8yySPU3oiXHfqjG_wtN_adapter_model.safetensors',
  kick: 'https://v3.fal.media/files/zebra/pTpvwSFWQVMwY9e-H9H1__adapter_model.safetensors',
  kick_alt: 'https://v3.fal.media/files/rabbit/wHyoYJLx1pYifFifUNRV3_adapter_model.safetensors',
  takedown: 'https://v3.fal.media/files/panda/iQtMcB3YcHmtjMNoixwsK_adapter_model.safetensors',
};
